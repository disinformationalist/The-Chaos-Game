...
void deserialize_game_data(t_game *game, const char *data) 
{
	...
	unsigned int color_1, color_2, color_3, color_4;
    ...
    sscanf(data,
		   ...
		   "color_depth=%d;color_op=%d;color_rot=%d;col_shift_x=%d;col_shift_y=%d;iters_change=%d",
		  ...
		  &game->col_shift_y, &game->iters_change);
